  ...
  return (
    <>
      <header className="sticky top-[var(--site-nav-h,64px)] z-20 bg-neutral-bg/90 backdrop-blur border-b border-white/10">
        <nav className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Link href="/example-work/realtime" className="text-lg font-serif font-bold text-text-base hover:text-accent">Realtime Chat & Notifications</Link>
          </div>
          <div className="hidden md:flex items-center gap-4 text-text-muted">
            <a href="#demo" className="hover:text-accent">Demo</a>
            <a href="#presence" className="hover:text-accent">Presence</a>
            <a href="#notifications" className="hover:text-accent">Notifications</a>
      ...
      <footer className="border-t border-white/10 py-8 text-center text-text-muted">
        © {new Date().getFullYear()} Realtime Demo — mock UI
      </footer>
    </>
  );
}
