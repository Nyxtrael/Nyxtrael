    ...
    <main role="main" className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
          ...
          <div className="card overflow-hidden rounded-2xl border border-purple-500/30 shadow-lg hover:shadow-xl hover:shadow-purple-500/20 transition-all duration-300">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4 text-left">
                <h2 className="text-3xl font-semibold text-white mb-1 font-montserrat">{featuredStudy.title}</h2>
                <p className="text-gray-400 text-base font-inter leading-snug">{featuredStudy.context}</p>
              </div>
              <div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex gap-2">
                <span className="bg-gradient-to-r from-purple-500 to-teal-500 text-white px-4 py-2 rounded-full font-montserrat text-sm font-semibold hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900 transform hover:scale-105 transition-transform duration-300">
                  View Case
                </span>
              </div>
            </Link>
          ...
          {otherStudies.map((study, i) => (
            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 to-transparent group-hover:bg-gray-900/50 transition-opacity duration-300"></div>
                <div className="absolute bottom-4 left-4 right-4 text-left">
                  <h2 className="text-xl font-semibold text-white mb-1 font-montserrat">{study.title}</h2>
                  <p className="text-gray-400 text-sm font-inter leading-snug">{study.context}</p>
      ...
      <footer className="py-10 bg-gray-800/50 text-gray-400 text-center border-t border-purple-500/20">
        <div className="container mx-auto space-y-4">
          ...
          <Link
            href="/contact"
            className="inline-block bg-gradient-to-r from-purple-500 to-teal-500 text-white px-6 py-3 rounded-full font-montserrat font-semibold hover:from-purple-600 hover:to-teal-600 transform hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900 shadow-lg"
          >
            Let’s Talk
          </Link>
        </div>
