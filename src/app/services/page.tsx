...
const services = [
  {
    ...
    examples: ['SaaS Dashboard', 'E-commerce Platform', 'Portfolio Website'], // Dodano pole examples
  },
  {
    title: 'UI/UX Design',
    ...
    examples: ['Landing Page Design', 'App Interface', 'Design System'], // Dodano pole examples
  },
  {
    title: 'Consulting',
    ...
    examples: ['SEO Audit', 'Performance Optimization', 'Tech Strategy'], // Dodano pole examples
  },
];
            ...
            {services.map((service, index) => (
              ...
              >
                <ServiceCard
                  ...
                  examples={service.examples} // Przekazano pole examples
                />
              </div>
            ))}
          </div>
