       ...
       <section className="hero-section relative min-h-screen flex items-center justify-center overflow-hidden">
         ...
         <div className="relative z-10 text-center px-6 container mx-auto">
           ...
           <div className="flex flex-col sm:flex-row justify-center gap-4">
             <Link
               href="/case-studies"
               className="btn-primary hover:scale-105 hover:animate-pulse animate-bounce-once transition-transform duration-300"
             >
               View Case Studies
             </Link>
             <Link
               href="/contact"
               className="btn-outline hover:scale-105 hover:animate-pulse animate-bounce-once transition-transform duration-300"
             >
               Get in Touch
             </Link>
           </div>
